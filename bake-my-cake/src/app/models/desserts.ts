...
export const Gifts: Gift[] = [
    { id: 1, name: 'Merry/Happpy 4-pack',imageURL:'../../assets/images/1sid.png',price:'9.50', description:'Six warm,cookies pre-wrapped in a Merry/Happy box sleeve and delivered to your friends and family.'},
